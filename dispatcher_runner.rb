...
options[:port] ||= (ARGV.shift || CHT_Configuration::Address::DefaultPorts::DISPATCHER_DEFAULT_PORT).to_i
...
dispatcher = Dispatcher.new :status_checker => status_checker, :decision_maker => decision_maker, :logger=>logger
