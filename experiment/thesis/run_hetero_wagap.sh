...
./run_exp.sh wagap-d5-b1-c0_001-w0_1-s0_01-hetero-Priority/wagap.sample.?

echo 'Running hetero EDF'
../../algorithm_changer.rb $D_MAKER_ADDR EarliestDeadlineFirstScheduling 
./run_exp.sh wagap-d5-b1-c0_001-w0_1-s0_01-hetero-EarliestDeadlineFirst/wagap.sample.?

echo 'Running hetero DeadlineNoPriority'
../../algorithm_changer.rb $D_MAKER_ADDR PreemptiveNoPriorityDeadlineBasedScheduling 
./run_exp.sh wagap-d5-b1-c0_001-w0_1-s0_01-hetero-DeadlineNoPriority/wagap.sample.?

echo 'Running hetero DeadlinePriority'
../../algorithm_changer.rb $D_MAKER_ADDR PreemptiveDeadlineBasedScheduling 
./run_exp.sh wagap-d5-b1-c0_001-w0_1-s0_01-hetero-DeadlinePriority/wagap.sample.?
